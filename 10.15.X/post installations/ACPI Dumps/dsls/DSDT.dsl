 ...
 *
 * Disassembly of DSDT.aml, Wed Jan  1 23:03:50 2020
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x00012EFC (77564)
 *     Revision         0x02
 *     Checksum         0x62
 *     OEM ID           "LENOVO"
 *     OEM Table ID     "TP-N1F  "
 ...
 */
DefinitionBlock ("", "DSDT", 2, "LENOVO", "TP-N1F  ", 0x00001150)
{
    /*
    ...
    OperationRegion (MNVS, SystemMemory, 0xD7F86018, 0x1000)
    ...
    OperationRegion (GNVS, SystemMemory, 0xD7F75000, 0x0600)
            ...
            Device (LPC)
            {
                ...
                Device (EC)
                {
                    ...
                    Field (ECOR, ByteAcc, NoLock, Preserve)
                    {
                        ...
                        HDAC,   2, 
                        Offset (0xB0), 
                        HDE0,8,HDE1,8,HDE2,8,HDE3,8, 
                        HDP0,8,HDP1,8,HDP2,8,HDP3,8, 
                        HDEM,   8, 
                        HDES,   8, 
                        Offset (0xC1), 
                        CMMD,   8, 
                    ...
                    Method (GBIF, 3, NotSerialized)
                    {
                        ...
                        If (Arg2)
                        {
                            ...
                            ElseIf (B1B2(SBV0,SBV1))
                            {
                                Divide (0x00030D40, B1B2(SBV0,SBV1), Local2, Index (Arg1, 0x06))
                            }
                            Else
                            {
                            ...
                            Store (B1B2(SBV0,SBV1), Index (Arg1, 0x04))
                            Store (B1B2(SBN0,SBN1), Local0)
                            ...
                            Store (B1B4(SBH0,SBH1,SBH2,SBH3), BTYP)
